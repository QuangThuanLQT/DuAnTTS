odoo.define('task_list_manager.systray', function (require) {
"use strict";
...
var ActivityMenu = Widget.extend({
    template:'task_list_manager.chat.ActivityMenu',
    events: {
    ...
    _getActivityData: function(){
        var self = this;
        return new Model("res.users").call("activity_user_count").then(function (data) {
    ...
    _updateActivityPreview: function () {
        ...
        self._getActivityData().then(function (){
            self.$activities_preview.html(QWeb.render('task_list_manager.chat.ActivityMenuPreview', {
...
//        	if (data.res_model==self.activities[i]['model']){
//        		ids = self.activities[i]['ids'];
//        		break;
//        	}
//        }
        this.do_action({
