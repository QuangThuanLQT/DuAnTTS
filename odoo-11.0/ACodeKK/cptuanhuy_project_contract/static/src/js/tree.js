odoo.define('cptuanhuy_project_contract.tree', function (require) {
    "use strict";
    ...
    var formats = require('web.formats');
     ...
     var NewFieldMany2One = form_relational.FieldMany2One.extend({
            ...
            return this.orderer.add(dataset.name_search(
                ...
                if (search_val.length > 0 && !_.include(raw_result, search_val) &&
                    ...
                    self.can_create && values.push({
                        ...
                        action: function() {
                            if (!(['res.partner', 'product.product', 'product.template'].includes(self.field.relation))) {
