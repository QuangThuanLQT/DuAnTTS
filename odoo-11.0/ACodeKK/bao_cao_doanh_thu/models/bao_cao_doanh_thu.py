...
class sale_order_line_report(models.TransientModel):
    ...
    def get_data_report(self):
        ...
        for order_line in order_line_ids:
            ...
            if order_line.product_id.default_code and (order_line.product_id.default_code[0:3] in ['CV-', 'TS-'] or order_line.product_id.default_code[0:4] in ['CDV-', 'CDS-'] or 'LIONDAP-' in order_line.product_id.default_code):
        ...
        tong_hop.append({
            ...
            'doanh_thu': "",
            'schneider': '{0:,.2f}'.format(schneider_sum_1 / doanh_thu_sum_1 * 100) + " %" if schneider_sum_1 and doanh_thu_sum_1 else '0.00 %',
            'ls': '{0:,.2f}'.format(ls_sum_1 / doanh_thu_sum_1 * 100) + " %" if ls_sum_1 and doanh_thu_sum_1 else '0.00 %',
            'th': '{0:,.2f}'.format(
            ...
            'day_dien': '{0:,.2f}'.format(day_dien_1 / doanh_thu_sum_1 * 100) + " %" if day_dien_1 and doanh_thu_sum_1 else '0.00 %',
            'mitsubishi': '{0:,.2f}'.format(mitsubishi_1 / doanh_thu_sum_1 * 100) + " %" if mitsubishi_1 and doanh_thu_sum_1 else '0.00 %',
        ...
        tong_hop.append({
            ...
            'schneider': '{0:,.2f}'.format(doanh_thu_tyle_2 / doanh_thu_sum_1 * 100) + " %" if doanh_thu_tyle_2 and doanh_thu_sum_1 else '0.00 %',
            'ls': False,
            'th': False,
            'sp': False,
            'day_dien': False,
        ...
        tong_hop.append({
            ...
            'schneider': '{0:,.2f}'.format(doanh_thu_tyle_3 / doanh_thu_sum_1 * 100) + " %" if doanh_thu_tyle_3 and doanh_thu_sum_1 else '0.00 %',
            'ls': False,
            'th': False,
            'sp': False,
            'day_dien': False,
